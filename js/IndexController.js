...
IndexController.prototype._showCachedMessages = function() {
  ...
  return this._dbPromise.then(function(db) {
    ...
    var index = db.transaction('currencyConveters')
      .objectStore('currencyConverters').index('by-date');
...
IndexController.prototype._cleanImageCache = function() {
  return this._dbPromise.then(function(db) {
    ...
    var tx = db.transaction('currencyConverters');
    return tx.objectStore('currencyConverters').getAll().then(function(messages) {
      ...
      return caches.open('currencyConverter-content-imgs');
    }).then(function(cache) {
