...
IndexController.prototype._registerServiceWorker = function() {
  ...
  navigator.serviceWorker.register('/js/serviceworker/sw.js').then(function(reg) {
...
IndexController.prototype._showCachedMessages = function() {
  ...
  return this._dbPromise.then(function(db) {
    ...
    var index = db.transaction('currencies')
      .objectStore('currencies').index('by-date');
...
IndexController.prototype._cleanImageCache = function() {
  return this._dbPromise.then(function(db) {
    ...
    var tx = db.transaction('curremcies');
    return tx.objectStore('currencies').getAll().then(function(messages) {
      ...
      return caches.open('currency-content-imgs');
    }).then(function(cache) {
