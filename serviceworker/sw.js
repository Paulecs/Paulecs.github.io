(function e(t, n, r) {
    ...
    self.addEventListener('install', event => {
      event.waitUntil(caches.open(staticCacheName).then(cache => cache.addAll(['/skeleton', 'js/main.js', 'css/main.css', 'imgs/icon.png', 'https://fonts.gstatic.com/s/roboto/v15/2UX7WLTfW3W8TclTUvlFyQ.woff', 'https://fonts.gstatic.com/s/roboto/v15/d-6IYplOFocCacKzxwXSOD8E0i7KZn-EPnyo3HZu7kw.woff','https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/popper.min.js','js/bootstrap.min.js','https://fonts.googleapis.com/css?family=Work+Sans','https://use.fontawesome.com/releases/v5.1.0/css/all.css'])));
    });
